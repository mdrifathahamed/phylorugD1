...
|----|----|
| [`read_trees_from_dir()`](https://mdrifathahamed.github.io/phylorugD1/reference/read_trees_from_dir.md) | Reads all tree files from a directory into a named list of phylo objects |
| [`check_same_taxa()`](https://mdrifathahamed.github.io/phylorugD1/reference/check_same_taxa.md) | Checks whether all trees share the same set of taxa — returns a green signal if they match |
| [`translate_tree_tips()`](https://mdrifathahamed.github.io/phylorugD1/reference/translate_tree_tips.md) | Translates tip labels from museum specimen codes to full species names using a lookup table |
| [`node_presence_matrix()`](https://mdrifathahamed.github.io/phylorugD1/reference/node_presence_matrix.md) | For each node in the backbone tree, records whether that clade is present in each comparison tree, returning a 0/1 or support-value matrix |
| [`rug_layout_map()`](https://mdrifathahamed.github.io/phylorugD1/reference/rug_layout_map.md) | Transforms the node support matrix into a long-format data frame mapping each analysis to a specific row and column position in the rug grid |
| [`plot_node_rug()`](https://mdrifathahamed.github.io/phylorugD1/reference/plot_node_rug.md) | Superimposes compact colour-coded grid cells onto the internal nodes of a plotted phylogenetic tree |
| [`rf_similarity_plot()`](https://mdrifathahamed.github.io/phylorugD1/reference/rf_similarity_plot.md) | Computes Robinson-Foulds distances between all trees and renders a 2D MDS scatter plot showing pairwise topological similarity |
